# Install instructions — GitHub Copilot Desktop App

You are helping the user install the Atlassian skill for the **GitHub Copilot desktop app**. Follow every step in order.

## 1. Install the skill

The desktop app reads skills from its app-skills folder. Download the raw files directly:

```powershell
# Windows
$dest = "$env:APPDATA\com.github.githubapp\app-skills\atlassian"
...
```bash
# Mac
DEST="$HOME/Library/Application Support/com.github.githubapp/app-skills/atlassian"
mkdir -p "$DEST/agents"
BASE="https://raw.githubusercontent.com/stevez-manulife/copilot-skills/main/skills/atlassian"
...
In the desktop app chat, trigger `/atlassian setup` and ask the user for:
